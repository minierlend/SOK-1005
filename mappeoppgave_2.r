...
##ggplot for å prøve å gjennskape bildet vi fikk utdelt.
...
##plot2 <- agnes(Covid_death, metric =  "manhattan", stand = TRUE)

##plot(plot2, which.plots = 2)
...
lm(deaths_per_100k ~ fully_vaccinated_pct_of_pop_percentage, data=Covid_death) 


## som vi ser på linja er at det er en tydelig korrelasjon mellom vaksineringsgrad og færre dødsfall.
...
#det negative tallet indikerer at når uavhengige tallet blir større, vil det avhengige tallet bli mindre. 
#vi ser at tallet er -0.3666, jo nærmere dette tallet er 1 eller -1 jo sterkere sammenheng vil det ha, det 
#oppsummerer graden av samsvar. I dette eksempelet har vi målt graden av samsvar hvor mange som  dør iforhold til 
#vaksinasjonsgrad. siden det er et negativt tall betyr det at det er negativ korrelasjon, og regresjonslinja går nedover. 
